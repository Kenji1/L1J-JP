...
public class C_NpcAction extends ClientBasePacket {
	...
	public C_NpcAction(byte abyte0[], ClientThread client) throws Exception {
		...
		// 錬金術師
				...
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46281
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46282
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46283
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46284
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46285
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46286
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46287
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46288
				|| ((L1NpcInstance) obj).getNpcTemplate().getNpcId() == 46289) {
			if (s.equalsIgnoreCase("request elven wafer")) {
				materials = new int[] { 40437, 40412, 40472, 40419 };
				counts = new int[] { 10, 10, 5, 3 };
				createitem = new int[] { 40068 }; // エルヴンワッフル
				createcount = new int[] { 2 };
				htmlid = "";
			} else if (s.equals("a")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 20 };
				htmlid = "";
			} else if (s.equals("b")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 10, 10000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 200 };
				htmlid = "";
			} else if (s.equals("c")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 1000 };
				htmlid = "";
			} else if (s.equals("d")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 40 };
				htmlid = "";
			} else if (s.equals("e")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 10, 10000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 400 };
				htmlid = "";
			} else if (s.equals("f")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 2000 };
				htmlid = "";
			} else if (s.equals("g")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40320 }; // 黒魔石
				createcount = new int[] { 10 };
				htmlid = "";
			} else if (s.equals("h")) {
				materials = new int[] { 40304, 40308 }; // マーブルの遺産
				counts = new int[] { 10, 10000 };
				...
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40320 }; // 黒魔石
				createcount = new int[] { 500 };
				htmlid = "";
			} else if (s.equals("j")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 25 };
				htmlid = "";
			} else if (s.equals("k")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 10, 10000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 250 };
				htmlid = "";
			} else if (s.equals("l")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 1250 };
				htmlid = "";
			} else if (s.equals("m")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 60 };
				htmlid = "";
			} else if (s.equals("n")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 10, 10000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 600 };
				htmlid = "";
			} else if (s.equals("o")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 3000 };
				htmlid = "";
			} else if (s.equals("p")) {
				materials = new int[] { 40307, 40308 }; // サイハの遺産
				counts = new int[] { 1, 1000 };
				...
				materials = new int[] { 40306, 40308 }; // エヴァの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 30 };
				htmlid = "";
			} else if (s.equals("t")) {
				materials = new int[] { 40306, 40308 }; // エヴァの遺産
				counts = new int[] { 10, 10000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 300 };
				htmlid = "";
			} else if (s.equals("u")) {
				materials = new int[] { 40306, 40308 }; // エヴァの遺産
				counts = new int[] { 50, 50000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 1500 };
				htmlid = "";
			} else if (s.equals("v")) {
				materials = new int[] { 40306, 40308 }; // エヴァの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40319 }; // 精霊の玉
				createcount = new int[] { 50 };
				htmlid = "";
			} else if (s.equals("w")) {
				materials = new int[] { 40306, 40308 }; // エヴァの遺産
				counts = new int[] { 10, 10000 };
				...
				materials = new int[] { 40305, 40308 }; // ファアグリオの遺産
				counts = new int[] { 1, 1000 };
				createitem = new int[] { 40318 }; // 魔力の石
				createcount = new int[] { 25 };
				htmlid = "";
				...
				materials = new int[] { 40524, 40308 }; // 黒い血痕
				counts = new int[] { 1, 10000 };
				createitem = new int[] { 40304, 40305, 40306, 40307 };
				createcount = new int[] { 1, 1, 1, 1 };
				htmlid = "";
			} else if (s.equals("L")) {
				materials = new int[] { 40524, 40308 }; // 黒い血痕
				counts = new int[] { 10, 100000 };
				createitem = new int[] { 40304, 40305, 40306, 40307 };
				createcount = new int[] { 10, 10, 10, 10 };
				htmlid = "";
			} else if (s.equals("M")) {
				materials = new int[] { 40524, 40308 }; // 黒い血痕
				counts = new int[] { 100, 1000000 };
				createitem = new int[] { 40304, 40305, 40306, 40307 };
				createcount = new int[] { 100, 100, 100, 100 };
				htmlid = "";
			}
		}
		// 佐ノ吉(ギラン → 惣構え)
