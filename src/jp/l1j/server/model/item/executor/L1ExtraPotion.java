...
public class L1ExtraPotion {
	...
	private static final String PATH = "./data/xml/Item/ExtraPotion.xml";

	private static final HashMap<Integer, L1ExtraPotion> _dataMap = new HashMap<Integer, L1ExtraPotion>();
	...
	public static void load() {
		...
		System.out.print("loading extra potion...");
		try {
