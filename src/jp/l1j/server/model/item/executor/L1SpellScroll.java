...
public class L1SpellScroll {

	private static Logger _log = Logger.getLogger(L1SpellScroll.class.getName());

	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlRootElement(name = "ItemEffectList")
	private static class ItemEffectList implements Iterable<L1SpellScroll> {
		@XmlElement(name = "Item")
		private List<L1SpellScroll> _list;

		public Iterator<L1SpellScroll> iterator() {
	...
	private static final String PATH = "./data/xml/Item/SpellScroll.xml";

	private static final HashMap<Integer, L1SpellScroll> _dataMap = new HashMap<Integer, L1SpellScroll>();

	public static L1SpellScroll get(int id) {
	...
	public static void load() {
		...
		System.out.print("loading spell scroll...");
		try {
			JAXBContext context = JAXBContext.newInstance(L1SpellScroll.ItemEffectList.class);
