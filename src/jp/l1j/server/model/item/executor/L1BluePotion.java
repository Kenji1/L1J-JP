...
public class L1BluePotion {
	...
	private static final String PATH = "./data/xml/Item/BluePotion.xml";

	private static final HashMap<Integer, L1BluePotion> _dataMap = new HashMap<Integer, L1BluePotion>();
	...
	public static void load() {
		...
		System.out.print("loading blue potion...");
		try {
